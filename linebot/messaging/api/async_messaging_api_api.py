...
class AsyncMessagingApiApi(object):
    ...
    @overload
    def broadcast(self, broadcast_request : BroadcastRequest, x_line_retry_key : Annotated[Optional[StrictStr], Field(description="Retry key. Specifies the UUID in hexadecimal format (e.g., `123e4567-e89b-12d3-a456-426614174000`) generated by any method. The retry key isn't generated by LINE. Each developer must generate their own retry key. ")] = None, async_req: Optional[bool]=True, **kwargs) -> None:  # noqa: E501
        ...
    ...
    @overload
    async def reply_message(self, reply_message_request : ReplyMessageRequest, **kwargs) -> None:  # noqa: E501
        ...

    @overload
    def reply_message(self, reply_message_request : ReplyMessageRequest, async_req: Optional[bool]=True, **kwargs) -> None:  # noqa: E501
        ...

    @validate_arguments
    def reply_message(self, reply_message_request : ReplyMessageRequest, async_req: Optional[bool]=None, **kwargs) -> Union[None, Awaitable[None]]:  # noqa: E501
