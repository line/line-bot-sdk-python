...
class VideoPlayComplete(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoPlayComplete:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoPlayComplete:
        """Create an instance of VideoPlayComplete from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoPlayComplete.parse_obj(obj)

        _obj = VideoPlayComplete.parse_obj({
