...
class RichMenuBatchUnlinkOperation(RichMenuBatchOperation):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RichMenuBatchUnlinkOperation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RichMenuBatchUnlinkOperation:
        """Create an instance of RichMenuBatchUnlinkOperation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RichMenuBatchUnlinkOperation.parse_obj(obj)

        _obj = RichMenuBatchUnlinkOperation.parse_obj({
            "type": obj.get("type"),
