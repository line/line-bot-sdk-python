...
import linebot.shop.models
from linebot.shop import async_rest
from linebot.shop.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(linebot.shop.models, klass)
