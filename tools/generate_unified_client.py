...
def generate_sync_client(
    ...
    lines.append('')
    lines.append('"""Unified LINE Bot Client.')
    lines.append('')
    ...
    lines.append('    """Unified LINE Bot client that delegates to individual API clients.')
    lines.append('')
    lines.append('    Auto-generated by tools/generate_unified_client.py.')
    lines.append('    Do not edit manually.')
    lines.append('')
...
def generate_async_client(
    ...
    lines.append('# coding: utf-8')
    lines.append('')
    lines.append('"""Unified Async LINE Bot Client.')
    lines.append('')
    lines.append('Auto-generated by tools/generate_unified_client.py.')
    lines.append('Do not edit manually.')
    lines.append('"""')
    ...
    lines.append('    """Unified async LINE Bot client that delegates to individual async API clients.')
    lines.append('')
    lines.append('    Auto-generated by tools/generate_unified_client.py.')
    lines.append('    Do not edit manually.')
    lines.append('')
...
def inject_docstring_references(
    ...
    def _build_new_tail(unified_class: str) -> str:
        return (
            '    Do not edit the class manually.\n'
            '\n'
            f'    Tip: Use :class:`linebot.v3.{unified_class}` for a unified client\n'
