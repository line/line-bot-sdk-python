...
class BroadcastRequest(BaseModel):
    ...
    __properties = ["messages", "notificationDisabled"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BroadcastRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BroadcastRequest:
        """Create an instance of BroadcastRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BroadcastRequest.parse_obj(obj)

        _obj = BroadcastRequest.parse_obj({
