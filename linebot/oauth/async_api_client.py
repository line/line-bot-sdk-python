...
import linebot.oauth.models
from linebot.oauth import async_rest
from linebot.oauth.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(linebot.oauth.models, klass)
