...
from linebot.webhook.models.action_result import ActionResult
...
class ScenarioResult(BaseModel):
    ...
    revision: Optional[StrictStr] = Field(None, description="Revision number of the scenario set containing the executed scenario")
