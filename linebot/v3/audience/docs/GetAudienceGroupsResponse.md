...
get_audience_groups_response_instance = GetAudienceGroupsResponse.from_json(json)
# print the JSON string representation of the object
print GetAudienceGroupsResponse.to_json()

# convert the object into a dict
get_audience_groups_response_dict = get_audience_groups_response_instance.to_dict()
# create an instance of GetAudienceGroupsResponse from a dict
get_audience_groups_response_form_dict = get_audience_groups_response.from_dict(get_audience_groups_response_dict)
```
