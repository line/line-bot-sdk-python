...
class CashBackFixedPriceInfoRequest(CashBackPriceInfoRequest):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CashBackFixedPriceInfoRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CashBackFixedPriceInfoRequest:
        """Create an instance of CashBackFixedPriceInfoRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CashBackFixedPriceInfoRequest.parse_obj(obj)

        _obj = CashBackFixedPriceInfoRequest.parse_obj({
            "type": obj.get("type"),
