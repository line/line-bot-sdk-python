...
class RichMenuIdResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RichMenuIdResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RichMenuIdResponse:
        """Create an instance of RichMenuIdResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RichMenuIdResponse.parse_obj(obj)

        _obj = RichMenuIdResponse.parse_obj({
