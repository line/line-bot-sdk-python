...
class TestWebhookParser(unittest.TestCase):
    def test_parse(self):
        ...
        self.assertEqual(events[24].things.scenario_id, 'XXX')
        self.assertEqual(events[24].things.revision, 2)
        self.assertEqual(events[24].things.start_time, 1547817845950)
        self.assertEqual(events[24].things.end_time, 1547817845952)
        self.assertEqual(events[24].things.result_code, 'success')
        self.assertEqual(events[24].things.ble_notification_payload, 'AQ==')
        self.assertIsInstance(events[24].things.action_results[0], ActionResult)
        self.assertEqual(events[24].things.action_results[0].type, 'binary')
        self.assertEqual(events[24].things.action_results[0].data, '/w==')
        self.assertIsInstance(events[24].things.action_results[1], ActionResult)
        self.assertEqual(events[24].things.action_results[1].type, 'void')
