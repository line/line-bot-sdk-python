...
class PostbackContent(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostbackContent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostbackContent:
        """Create an instance of PostbackContent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostbackContent.parse_obj(obj)

        _obj = PostbackContent.parse_obj({
            "data": obj.get("data"),
