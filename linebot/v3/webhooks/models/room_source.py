...
class RoomSource(Source):
    ...
    room_id: StrictStr = Field(..., alias="roomId", description="Room ID of the source multi-person chat")
    type: str = "room"

    __properties = ["type", "userId", "roomId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RoomSource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RoomSource:
        """Create an instance of RoomSource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RoomSource.parse_obj(obj)

        _obj = RoomSource.parse_obj({
            "type": obj.get("type"),
