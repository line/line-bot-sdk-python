...
class CouponCreateResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CouponCreateResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CouponCreateResponse:
        """Create an instance of CouponCreateResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CouponCreateResponse.parse_obj(obj)

        _obj = CouponCreateResponse.parse_obj({
