...
class CashBackPercentagePriceInfoResponse(CashBackPriceInfoResponse):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CashBackPercentagePriceInfoResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CashBackPercentagePriceInfoResponse:
        """Create an instance of CashBackPercentagePriceInfoResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CashBackPercentagePriceInfoResponse.parse_obj(obj)

        _obj = CashBackPercentagePriceInfoResponse.parse_obj({
            "type": obj.get("type"),
