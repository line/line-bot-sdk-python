...
class DiscountExplicitPriceInfoRequest(DiscountPriceInfoRequest):
    ...
    __properties = ["type", "priceAfterDiscount", "originalPrice"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DiscountExplicitPriceInfoRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DiscountExplicitPriceInfoRequest:
        """Create an instance of DiscountExplicitPriceInfoRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DiscountExplicitPriceInfoRequest.parse_obj(obj)

        _obj = DiscountExplicitPriceInfoRequest.parse_obj({
            "type": obj.get("type"),
