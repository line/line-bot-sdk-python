...
class AsyncInsight(object):
    ...
    @overload
    def get_friends_demographics(self, async_req: Optional[bool]=True, **kwargs) -> GetFriendsDemographicsResponse:  # noqa: E501
        ...
    ...
    @overload
    async def get_message_event(self, request_id : Annotated[constr(strict=True, min_length=1), Field(..., description="Request ID of a narrowcast message or broadcast message. Each Messaging API request has a request ID. ")], **kwargs) -> GetMessageEventResponse:  # noqa: E501
        ...

    @overload
    def get_message_event(self, request_id : Annotated[constr(strict=True, min_length=1), Field(..., description="Request ID of a narrowcast message or broadcast message. Each Messaging API request has a request ID. ")], async_req: Optional[bool]=True, **kwargs) -> GetMessageEventResponse:  # noqa: E501
        ...
    ...
    @overload
    async def get_number_of_followers(self, var_date : Annotated[Optional[constr(strict=True, max_length=8, min_length=8)], Field(description="Date for which to retrieve the number of followers.  Format: yyyyMMdd (e.g. 20191231) Timezone: UTC+9 ")] = None, **kwargs) -> GetNumberOfFollowersResponse:  # noqa: E501
        ...

    @overload
    def get_number_of_followers(self, var_date : Annotated[Optional[constr(strict=True, max_length=8, min_length=8)], Field(description="Date for which to retrieve the number of followers.  Format: yyyyMMdd (e.g. 20191231) Timezone: UTC+9 ")] = None, async_req: Optional[bool]=True, **kwargs) -> GetNumberOfFollowersResponse:  # noqa: E501
        ...
    ...
    @overload
    async def get_number_of_message_deliveries(self, var_date : Annotated[constr(strict=True, max_length=8, min_length=8), Field(..., description="Date for which to retrieve number of sent messages. - Format: yyyyMMdd (e.g. 20191231) - Timezone: UTC+9 ")], **kwargs) -> GetNumberOfMessageDeliveriesResponse:  # noqa: E501
        ...

    @overload
    def get_number_of_message_deliveries(self, var_date : Annotated[constr(strict=True, max_length=8, min_length=8), Field(..., description="Date for which to retrieve number of sent messages. - Format: yyyyMMdd (e.g. 20191231) - Timezone: UTC+9 ")], async_req: Optional[bool]=True, **kwargs) -> GetNumberOfMessageDeliveriesResponse:  # noqa: E501
        ...
    ...
    @overload
    def get_rich_menu_insight_daily(self, rich_menu_id : Annotated[StrictStr, Field(..., description="ID of the rich menu created via the Messaging API.")], var_from : Annotated[constr(strict=True, max_length=8, min_length=8), Field(..., description="Start date of the aggregation period (inclusive). Must be within the most recent 3 years.  Format: yyyyMMdd (e.g. 20260213) Time zone: UTC+9 ")], to : Annotated[constr(strict=True, max_length=8, min_length=8), Field(..., description="End date of the aggregation period (inclusive). The end date can be specified for up to 99 days after the start date.  Format: yyyyMMdd (e.g. 20260215) Time zone: UTC+9 ")], async_req: Optional[bool]=True, **kwargs) -> GetRichMenuInsightDailyResponse:  # noqa: E501
        ...

    @validate_arguments
    def get_rich_menu_insight_daily(self, rich_menu_id : Annotated[StrictStr, Field(..., description="ID of the rich menu created via the Messaging API.")], var_from : Annotated[constr(strict=True, max_length=8, min_length=8), Field(..., description="Start date of the aggregation period (inclusive). Must be within the most recent 3 years.  Format: yyyyMMdd (e.g. 20260213) Time zone: UTC+9 ")], to : Annotated[constr(strict=True, max_length=8, min_length=8), Field(..., description="End date of the aggregation period (inclusive). The end date can be specified for up to 99 days after the start date.  Format: yyyyMMdd (e.g. 20260215) Time zone: UTC+9 ")], async_req: Optional[bool]=None, **kwargs) -> Union[GetRichMenuInsightDailyResponse, Awaitable[GetRichMenuInsightDailyResponse]]:  # noqa: E501
    ...
    @overload
    def get_rich_menu_insight_summary(self, rich_menu_id : Annotated[StrictStr, Field(..., description="ID of the rich menu created via the Messaging API.")], var_from : Annotated[constr(strict=True, max_length=8, min_length=8), Field(..., description="Start date of the aggregation period (inclusive). Must be within the most recent 3 years.  Format: yyyyMMdd (e.g. 20260213) Time zone: UTC+9 ")], to : Annotated[constr(strict=True, max_length=8, min_length=8), Field(..., description="End date of the aggregation period (inclusive). The end date can be specified for up to 396 days after the start date.  Format: yyyyMMdd (e.g. 20260215) Time zone: UTC+9 ")], async_req: Optional[bool]=True, **kwargs) -> GetRichMenuInsightSummaryResponse:  # noqa: E501
        ...

    @validate_arguments
    def get_rich_menu_insight_summary(self, rich_menu_id : Annotated[StrictStr, Field(..., description="ID of the rich menu created via the Messaging API.")], var_from : Annotated[constr(strict=True, max_length=8, min_length=8), Field(..., description="Start date of the aggregation period (inclusive). Must be within the most recent 3 years.  Format: yyyyMMdd (e.g. 20260213) Time zone: UTC+9 ")], to : Annotated[constr(strict=True, max_length=8, min_length=8), Field(..., description="End date of the aggregation period (inclusive). The end date can be specified for up to 396 days after the start date.  Format: yyyyMMdd (e.g. 20260215) Time zone: UTC+9 ")], async_req: Optional[bool]=None, **kwargs) -> Union[GetRichMenuInsightSummaryResponse, Awaitable[GetRichMenuInsightSummaryResponse]]:  # noqa: E501
    ...
    @overload
    def get_statistics_per_unit(self, custom_aggregation_unit : Annotated[constr(strict=True, max_length=30, min_length=1), Field(..., description="Name of aggregation unit specified when sending the message. Case-sensitive. For example, `Promotion_a` and `Promotion_A` are regarded as different unit names. ")], var_from : Annotated[constr(strict=True, max_length=8, min_length=8), Field(..., description="Start date of aggregation period.  Format: yyyyMMdd (e.g. 20210301) Time zone: UTC+9 ")], to : Annotated[constr(strict=True, max_length=8, min_length=8), Field(..., description="End date of aggregation period. The end date can be specified for up to 30 days later. For example, if the start date is 20210301, the latest end date is 20210331.  Format: yyyyMMdd (e.g. 20210301) Time zone: UTC+9 ")], async_req: Optional[bool]=True, **kwargs) -> GetStatisticsPerUnitResponse:  # noqa: E501
        ...
