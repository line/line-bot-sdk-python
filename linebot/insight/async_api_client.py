...
import linebot.insight.models
from linebot.insight import async_rest
from linebot.insight.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(linebot.insight.models, klass)
