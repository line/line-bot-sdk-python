...
from linebot.webhook.models.joined_members import JoinedMembers
...
class MemberJoinedEvent(Event):
    ...
    type: str = "memberJoined"

    __properties = ["type", "source", "timestamp", "mode", "webhookEventId", "deliveryContext", "replyToken", "joined"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MemberJoinedEvent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MemberJoinedEvent:
        """Create an instance of MemberJoinedEvent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MemberJoinedEvent.parse_obj(obj)

        _obj = MemberJoinedEvent.parse_obj({
            "type": obj.get("type"),
            ...
            "joined": JoinedMembers.from_dict(obj.get("joined")) if obj.get("joined") is not None else None
        })
        return _obj
