...
class DiscountPercentagePriceInfoResponse(DiscountPriceInfoResponse):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DiscountPercentagePriceInfoResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DiscountPercentagePriceInfoResponse:
        """Create an instance of DiscountPercentagePriceInfoResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DiscountPercentagePriceInfoResponse.parse_obj(obj)

        _obj = DiscountPercentagePriceInfoResponse.parse_obj({
            "type": obj.get("type"),
