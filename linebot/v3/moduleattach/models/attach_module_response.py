...
class AttachModuleResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttachModuleResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttachModuleResponse:
        """Create an instance of AttachModuleResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AttachModuleResponse.parse_obj(obj)

        _obj = AttachModuleResponse.parse_obj({
