...
from linebot.webhooks import async_rest
from linebot.webhooks.exceptions import ApiValueError, ApiException
...
class AsyncApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'line-bot-sdk-python-async/1.0.0'
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(linebot.webhooks.models, klass)
