...
**owner** | [**DetailedOwner**](DetailedOwner.md) |  | [optional] 
...
get_shared_audience_data_response_instance = GetSharedAudienceDataResponse.from_json(json)
# print the JSON string representation of the object
print GetSharedAudienceDataResponse.to_json()

# convert the object into a dict
get_shared_audience_data_response_dict = get_shared_audience_data_response_instance.to_dict()
# create an instance of GetSharedAudienceDataResponse from a dict
get_shared_audience_data_response_form_dict = get_shared_audience_data_response.from_dict(get_shared_audience_data_response_dict)
```
