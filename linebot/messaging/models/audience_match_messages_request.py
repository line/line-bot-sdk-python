...
class AudienceMatchMessagesRequest(BaseModel):
    ...
    """
    messages: conlist(Message, max_items=5, min_items=1) = Field(..., description="Destination of the message (A value obtained by hashing the telephone number, which is another value normalized to E.164 format, with SHA256).")
    to: conlist(StrictStr, max_items=500, min_items=1) = Field(..., description="Message to send.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AudienceMatchMessagesRequest:
        """Create an instance of AudienceMatchMessagesRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AudienceMatchMessagesRequest:
        """Create an instance of AudienceMatchMessagesRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AudienceMatchMessagesRequest.parse_obj(obj)

        _obj = AudienceMatchMessagesRequest.parse_obj({
