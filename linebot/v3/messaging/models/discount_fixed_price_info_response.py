...
class DiscountFixedPriceInfoResponse(DiscountPriceInfoResponse):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DiscountFixedPriceInfoResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DiscountFixedPriceInfoResponse:
        """Create an instance of DiscountFixedPriceInfoResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DiscountFixedPriceInfoResponse.parse_obj(obj)

        _obj = DiscountFixedPriceInfoResponse.parse_obj({
            "type": obj.get("type"),
