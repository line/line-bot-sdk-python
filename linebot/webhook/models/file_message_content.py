...
class FileMessageContent(MessageContent):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileMessageContent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FileMessageContent:
        """Create an instance of FileMessageContent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileMessageContent.parse_obj(obj)

        _obj = FileMessageContent.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
