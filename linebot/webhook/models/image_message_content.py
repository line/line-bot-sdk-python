...
from linebot.webhook.models.content_provider import ContentProvider
from linebot.webhook.models.image_set import ImageSet
from linebot.webhook.models.message_content import MessageContent
...
class ImageMessageContent(MessageContent):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ImageMessageContent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ImageMessageContent:
        """Create an instance of ImageMessageContent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ImageMessageContent.parse_obj(obj)

        _obj = ImageMessageContent.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
