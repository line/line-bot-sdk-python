...
class CashBackFixedPriceInfoResponse(CashBackPriceInfoResponse):
    ...
    fixed_amount: Optional[StrictInt] = Field(None, alias="fixedAmount")
    type: str = "fixed"

    __properties = ["type", "currency", "fixedAmount"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CashBackFixedPriceInfoResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CashBackFixedPriceInfoResponse:
        """Create an instance of CashBackFixedPriceInfoResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CashBackFixedPriceInfoResponse.parse_obj(obj)

        _obj = CashBackFixedPriceInfoResponse.parse_obj({
            "type": obj.get("type"),
