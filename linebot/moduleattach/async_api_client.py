...
import linebot.moduleattach.models
from linebot.moduleattach import async_rest
from linebot.moduleattach.exceptions import ApiValueError, ApiException
...
class AsyncApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'line-bot-sdk-python-async/3.0.1'
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(linebot.moduleattach.models, klass)
