...
class TemplateMessage(Message):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TemplateMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TemplateMessage:
        """Create an instance of TemplateMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TemplateMessage.parse_obj(obj)

        _obj = TemplateMessage.parse_obj({
            "type": obj.get("type"),
