...
class TemplateSendMessage(SendMessage):
    def __init__(self, alt_text=None, template=None, **kwargs):
        ...
        Args:
            alt_text: Alternative text for unsupported devices.
            template: Object with the contents of the template.
            **kwargs:
        """
...
class ButtonsTemplate(Base):
    def __init__(
            self, text=None, title=None, thumbnail_image_url=None,
            actions=None, **kwargs
    ):
        """ButtonsTemplate
