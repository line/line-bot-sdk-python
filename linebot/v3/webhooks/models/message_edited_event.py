...
class MessageEditedEvent(Event):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MessageEditedEvent:
        """Create an instance of MessageEditedEvent from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MessageEditedEvent:
        """Create an instance of MessageEditedEvent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MessageEditedEvent.parse_obj(obj)

        _obj = MessageEditedEvent.parse_obj({
            "type": obj.get("type"),
