...
class NarrowcastRequest(BaseModel):
    """
    NarrowcastRequest
    https://developers.line.biz/en/reference/messaging-api/#send-narrowcast-message
    """
    messages: conlist(Message, max_items=5, min_items=1) = Field(..., description="List of Message objects.")
    ...
    __properties = ["messages", "recipient", "filter", "limit", "notificationDisabled"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NarrowcastRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NarrowcastRequest:
        """Create an instance of NarrowcastRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NarrowcastRequest.parse_obj(obj)

        _obj = NarrowcastRequest.parse_obj({
            ...
            "limit": Limit.from_dict(obj.get("limit")) if obj.get("limit") is not None else None,
