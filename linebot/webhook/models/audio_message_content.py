...
class AudioMessageContent(MessageContent):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AudioMessageContent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AudioMessageContent:
        """Create an instance of AudioMessageContent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AudioMessageContent.parse_obj(obj)

        _obj = AudioMessageContent.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
