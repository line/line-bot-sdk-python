...
class MessagingApi(object):
    ...
    @validate_arguments
    def cancel_default_rich_menu(self, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def close_coupon(self, coupon_id : StrictStr, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def create_coupon(self, coupon_create_request : Optional[CouponCreateRequest] = None, **kwargs) -> CouponCreateResponse:  # noqa: E501
    ...
    @validate_arguments
    def create_rich_menu(self, rich_menu_request : RichMenuRequest, **kwargs) -> RichMenuIdResponse:  # noqa: E501
    ...
    @validate_arguments
    def create_rich_menu_alias(self, create_rich_menu_alias_request : CreateRichMenuAliasRequest, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def delete_rich_menu(self, rich_menu_id : Annotated[StrictStr, Field(..., description="ID of a rich menu")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def delete_rich_menu_alias(self, rich_menu_alias_id : Annotated[StrictStr, Field(..., description="Rich menu alias ID that you want to delete.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def get_aggregation_unit_usage(self, **kwargs) -> GetAggregationUnitUsageResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_bot_info(self, **kwargs) -> BotInfoResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_coupon_detail(self, coupon_id : StrictStr, **kwargs) -> CouponResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_default_rich_menu_id(self, **kwargs) -> RichMenuIdResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_group_member_count(self, group_id : Annotated[StrictStr, Field(..., description="Group ID")], **kwargs) -> GroupMemberCountResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_group_summary(self, group_id : Annotated[StrictStr, Field(..., description="Group ID")], **kwargs) -> GroupSummaryResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_membership_list(self, **kwargs) -> MembershipListResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_membership_subscription(self, user_id : Annotated[StrictStr, Field(..., description="User ID")], **kwargs) -> GetMembershipSubscriptionResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_message_quota_consumption(self, **kwargs) -> QuotaConsumptionResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_narrowcast_progress(self, request_id : Annotated[StrictStr, Field(..., description="The narrowcast message's request ID. Each Messaging API request has a request ID.")], **kwargs) -> NarrowcastProgressResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_number_of_sent_broadcast_messages(self, var_date : Annotated[StrictStr, Field(..., description="Date the messages were sent  Format: yyyyMMdd (e.g. 20191231) Timezone: UTC+9 ")], **kwargs) -> NumberOfMessagesResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_number_of_sent_multicast_messages(self, var_date : Annotated[StrictStr, Field(..., description="Date the messages were sent  Format: `yyyyMMdd` (e.g. `20191231`) Timezone: UTC+9 ")], **kwargs) -> NumberOfMessagesResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_number_of_sent_push_messages(self, var_date : Annotated[StrictStr, Field(..., description="Date the messages were sent  Format: `yyyyMMdd` (e.g. `20191231`) Timezone: UTC+9 ")], **kwargs) -> NumberOfMessagesResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_number_of_sent_reply_messages(self, var_date : Annotated[StrictStr, Field(..., description="Date the messages were sent  Format: `yyyyMMdd` (e.g. `20191231`) Timezone: UTC+9 ")], **kwargs) -> NumberOfMessagesResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_profile(self, user_id : Annotated[StrictStr, Field(..., description="User ID")], **kwargs) -> UserProfileResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_rich_menu(self, rich_menu_id : Annotated[StrictStr, Field(..., description="ID of a rich menu")], **kwargs) -> RichMenuResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_rich_menu_alias(self, rich_menu_alias_id : Annotated[StrictStr, Field(..., description="The rich menu alias ID whose information you want to obtain.")], **kwargs) -> RichMenuAliasResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_rich_menu_alias_list(self, **kwargs) -> RichMenuAliasListResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_rich_menu_batch_progress(self, request_id : Annotated[StrictStr, Field(..., description="A request ID used to batch control the rich menu linked to the user. Each Messaging API request has a request ID.")], **kwargs) -> RichMenuBatchProgressResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_rich_menu_id_of_user(self, user_id : Annotated[StrictStr, Field(..., description="User ID. Found in the `source` object of webhook event objects. Do not use the LINE ID used in LINE.")], **kwargs) -> RichMenuIdResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_rich_menu_list(self, **kwargs) -> RichMenuListResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_room_member_count(self, room_id : Annotated[StrictStr, Field(..., description="Room ID")], **kwargs) -> RoomMemberCountResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_webhook_endpoint(self, **kwargs) -> GetWebhookEndpointResponse:  # noqa: E501
    ...
    @validate_arguments
    def issue_link_token(self, user_id : Annotated[StrictStr, Field(..., description="User ID for the LINE account to be linked. Found in the `source` object of account link event objects. Do not use the LINE ID used in LINE. ")], **kwargs) -> IssueLinkTokenResponse:  # noqa: E501
    ...
    @validate_arguments
    def leave_group(self, group_id : Annotated[StrictStr, Field(..., description="Group ID")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def leave_room(self, room_id : Annotated[StrictStr, Field(..., description="Room ID")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def link_rich_menu_id_to_user(self, user_id : Annotated[StrictStr, Field(..., description="User ID. Found in the `source` object of webhook event objects. Do not use the LINE ID used in LINE.")], rich_menu_id : Annotated[StrictStr, Field(..., description="ID of a rich menu")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def link_rich_menu_id_to_users(self, rich_menu_bulk_link_request : RichMenuBulkLinkRequest, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def mark_messages_as_read(self, mark_messages_as_read_request : MarkMessagesAsReadRequest, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def push_messages_by_phone(self, pnp_messages_request : PnpMessagesRequest, x_line_delivery_tag : Annotated[Optional[constr(strict=True, max_length=100, min_length=16)], Field(description="String returned in the delivery.data property of the delivery completion event via Webhook.")] = None, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def set_default_rich_menu(self, rich_menu_id : Annotated[StrictStr, Field(..., description="ID of a rich menu")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def set_webhook_endpoint(self, set_webhook_endpoint_request : SetWebhookEndpointRequest, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def unlink_rich_menu_id_from_user(self, user_id : Annotated[StrictStr, Field(..., description="User ID. Found in the `source` object of webhook event objects. Do not use the LINE ID used in LINE.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def unlink_rich_menu_id_from_users(self, rich_menu_bulk_unlink_request : RichMenuBulkUnlinkRequest, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def update_rich_menu_alias(self, rich_menu_alias_id : Annotated[StrictStr, Field(..., description="The rich menu alias ID you want to update.")], update_rich_menu_alias_request : UpdateRichMenuAliasRequest, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def validate_broadcast(self, validate_message_request : ValidateMessageRequest, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def validate_multicast(self, validate_message_request : ValidateMessageRequest, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def validate_narrowcast(self, validate_message_request : ValidateMessageRequest, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def validate_push(self, validate_message_request : ValidateMessageRequest, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def validate_reply(self, validate_message_request : ValidateMessageRequest, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def validate_rich_menu_batch_request(self, rich_menu_batch_request : RichMenuBatchRequest, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def validate_rich_menu_object(self, rich_menu_request : RichMenuRequest, **kwargs) -> None:  # noqa: E501
