...
from linebot.webhook.models.user_source import UserSource
...
class JoinedMembers(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JoinedMembers:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JoinedMembers:
        """Create an instance of JoinedMembers from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JoinedMembers.parse_obj(obj)

        _obj = JoinedMembers.parse_obj({
            "members": [UserSource.from_dict(_item) for _item in obj.get("members")] if obj.get("members") is not None else None
        })
        return _obj
