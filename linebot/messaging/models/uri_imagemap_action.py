...
class URIImagemapAction(ImagemapAction):
    ...
    __properties = ["type", "area", "linkUri", "label"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> URIImagemapAction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> URIImagemapAction:
        """Create an instance of URIImagemapAction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return URIImagemapAction.parse_obj(obj)

        _obj = URIImagemapAction.parse_obj({
            "type": obj.get("type"),
            "area": ImagemapArea.from_dict(obj.get("area")) if obj.get("area") is not None else None,
            "link_uri": obj.get("linkUri"),
            "label": obj.get("label")
        })
        return _obj
