...
class ChatControl(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChatControl:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChatControl:
        """Create an instance of ChatControl from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChatControl.parse_obj(obj)

        _obj = ChatControl.parse_obj({
