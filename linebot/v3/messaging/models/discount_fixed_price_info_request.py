...
class DiscountFixedPriceInfoRequest(DiscountPriceInfoRequest):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DiscountFixedPriceInfoRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DiscountFixedPriceInfoRequest:
        """Create an instance of DiscountFixedPriceInfoRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DiscountFixedPriceInfoRequest.parse_obj(obj)

        _obj = DiscountFixedPriceInfoRequest.parse_obj({
            "type": obj.get("type"),
