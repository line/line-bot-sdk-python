...
class Action(BaseModel):
    ...
    """
    type: Optional[StrictStr] = Field(None, description="Type of action")
    label: Optional[StrictStr] = Field(None, description="Label for the action.")
    ...
    def from_dict(cls, obj: dict) -> Union(CameraAction, CameraRollAction, DatetimePickerAction, LocationAction, MessageAction, PostbackAction, RichMenuSwitchAction, URIAction):
        ...
        if object_type:
            ...
            raise ValueError("Action failed to lookup discriminator value from " +
