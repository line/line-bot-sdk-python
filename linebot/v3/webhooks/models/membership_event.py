...
class MembershipEvent(Event):
    ...
    __properties = ["type", "source", "timestamp", "mode", "webhookEventId", "deliveryContext", "replyToken", "membership"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MembershipEvent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MembershipEvent:
        """Create an instance of MembershipEvent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MembershipEvent.parse_obj(obj)

        _obj = MembershipEvent.parse_obj({
            "type": obj.get("type"),
            ...
            "membership": MembershipContent.from_dict(obj.get("membership")) if obj.get("membership") is not None else None
        })
        return _obj
